        ...
        foreach ($domains as $domain) {
            ...
            WhmcsHosting::updateOrCreate(
                ...
                [
                    ...
                    'username' => $domain['hosting_username'] ?? null,
                    'diskusage' => $domain['hosting_diskusage'] ?? null,
                    'disklimit' => $domain['hosting_disklimit'] ?? null,
                    'bwusage' => $domain['hosting_bwusage'] ?? null,
                    'bwlimit' => $domain['hosting_bwlimit'] ?? null,
        ...
        foreach ($hostings as $hosting) {
            WhmcsHosting::updateOrCreate(
                ...
                [
                    ...
                    'username' => $hosting['username'] ?? null,
                    'diskusage' => $hosting['diskusage'] ?? null,
                    'disklimit' => $hosting['disklimit'] ?? null,
                    'bwusage' => $hosting['bwusage'] ?? null,
                    'bwlimit' => $hosting['bwlimit'] ?? null,
