...
class WHMCSCustomService
{
    ...
    public function getDomainsExpiry(?string $start_date = null, ?string $end_date = null): array
    {
        $params = [
            'action'       => 'expiry',
            'responsetype' => 'json',
            ...
            'end_date'     => $end_date ?? Carbon::now()->endOfMonth()->format('Y-m-d'),
        ];
    ...
    public function getHostingsExpiry(?string $start_date = null, ?string $end_date = null): array
    {
        $params = [
            'action'       => 'expiry',
            'responsetype' => 'json',
        ...
        $url = rtrim($this->apiUrl, '/') . '/get-hostings.php';
    ...
    public function getExpiredMonth(?string $month = null): array
    {
        $params = [
            'action'       => 'expiry',
            'responsetype' => 'json',
        ...
        $url = rtrim($this->apiUrl, '/') . '/get-expired-month.php';
