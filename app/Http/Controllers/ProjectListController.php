...
class ProjectListController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($status_pengerjaan) {
            ...
            elseif ($status_pengerjaan == 'Dalam pengerjaan') {
                $query->whereHas('wm_project', function ($query) {
            ...
            elseif ($status_pengerjaan == 'Menunggu koreksi' || $status_pengerjaan == 'Proses koreksi' || $status_pengerjaan == 'Kurang konfirmasi') {
