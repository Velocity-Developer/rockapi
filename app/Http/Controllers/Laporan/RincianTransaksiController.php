...
class RincianTransaksiController extends Controller
{
    ...
    private function rincian(array|string $jenisData, int $minimal, string $jenisFilter, string $namaTabel, Carbon $dari, Carbon $sampai, TanggalFormatterHelper $formatter): array
    {
        ...
        return $grouped->map(function ($items, $month) use ($formatter) {
            ...
            $biayaIklan = $this->adsPrice($month);
    ...
    private function adsPrice(string $month): int
    {
